...
keywords_responses = {
    "کار": [
        "خب بگو ببینم چه کاریه؟ اگه چوپانیه که تخصص منه!",
        "ببینم کار یا کار؟ از اون کارا نباشه...",
        "حرف از کار شد، من دیگه یاد گوسفندام افتادم.",
        "کار می‌کنی یا اداشو درمیاری؟",
        "بیا کارو بسپار به من، راحت شی."
    ],
    "چوپان": [
        "اسم منو صدا زدی؟ بله خودمم، چوپان ماد... ببخشید vip.",
        "چوپان اومد، کار رو بسپارید به من.",
        "چوپان اگه باشی باید بتونی گرگ رو از گوسفند تشخیص بدی!",
        "چوپان اینجاست، جُک بگید!",
        "چوپان فقط اسم نیست، یه لایف‌استایله."
    ],
    "خسته": [
        "خسته‌ای؟ بیا یه چایی بخور، بعد برو ادامه بده.",
        "همه خستن، ولی فقط بعضیا ادامه میدن.",
        "تو خسته‌ای، ولی کار هنوز مونده رفیق.",
        "اگه خسته‌ای، حتماً داری درست می‌ری.",
        "بیا وسط گله بشین، یه نفس بگیر."
    ],
    "اسممو گفت": [
        "بازم اسم منو آورد؟ این بار آخرته!",
        "هزار بار گفتم اسم منو نیار، خسته شدم.",
        "اسم منو بیاری یعنی کار داری؟",
        "هر کی اسممو بیاره باید یه جمله خفن هم بگه!",
        "اسم من مثل ورد جادوئه، مراقب باش."
    ],
    "گم شد": [
        "کی گم شد؟ چوپان پیدا می‌کنه.",
        "یه نفر گم شده؟ نترس، GPS من فعاله.",
        "بذار دنبال رد پا بگردم، شاید پیداش کنم."
    ],
    "جو": [
        "جو کمه؟ الان زنگ می‌زنم به انبار!",
        "جو نبود؟ گوسفندا شور می‌زنن الان.",
        "جو نیست؟ پس بریم سراغ علف خشک!"
    ]
}

fallback_responses = [
    "یه بار دیگه بگو ببینم چی گفتی؟",
    "نمی‌فهمم دقیقا چی گفتی ولی به نظر باحال میاد!",
    "صدا زدی؟ من همیشه آماده‌م!",
    "با من بودی یا با گوسفندا؟",
    "الان مغزم هنگ کرد، یه بار دیگه بگو!"
]
...
def generate_response(user_message: str) -> str:
    ...
    for keyword, lines in keywords_responses.items():
